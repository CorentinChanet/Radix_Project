...
class RegxSections(Enum):
    ...
    skills = r'(techn.{2,8}|core|key|area.?|professional|additional|organization.{0,2}|software|it|industry|personal.{0,3}|computer|relevant|hard.{0,5}|soft|practical).{0,4}(skil.{1,10}$|trait.?|knowledge|strength.?|proficiency|competenc.{1,4}|capabilit.{1,4}|capacit.{1,4}|abilit.{1,4}|experti.e|literacy)|^.?skill.{0,4}|^.?strength.{0,4}|^.?proficienc.{1,3}'
